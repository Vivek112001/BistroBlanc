...
<div class="container m-5 p-5">
        ...
        <div class="d-flex gap-0 column-gap-3">
            ...
            <div class=" gap-0 row-gap-3 d-inline-flex flex-column justify-content-center me-5">
                    ...
                    <div class="d-flex gap-0 column-gap-3">
                      <a href="addcart?item_id=${object1.item_id}&email=<%=id%>" class="link-underline-light link-dark link-underline-opacity-0 link-offset-3-hover link-offset-2 "><button type="submit" class="btn align-self-start btn-primary">Buy Now</button></a>
